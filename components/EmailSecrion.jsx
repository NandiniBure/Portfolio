...
export const EmailSecrion = () => {
  ...
  return (
    <section
      id="contact"
      className="grid md:grid-cols-2 relative my-12 md:my-12 py-24 gap-4"
    >
      ...
      <div className=" text-white  flex flex-col">
        ...
        <span>Email Id : nandinibure@gmail.com</span>
        <span>Phone : 9420426614</span>
        <div className=" socials flex flex-row gap-2">
          <Link href="https://github.com/NandiniBure">
            <Image src={GithubIcon} alt="Github icon" />
          </Link>
          <Link href="https://www.linkedin.com/in/nandini-bure-0563ab253/">
